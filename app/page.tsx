...
export default function Page() {
  return (
    <Layout>
      <section id="home">
        <div className="md:px-4 pt-16 md:pt-20 md:flex h-full">
          <div className="pt-8">
      ...
      <section id="components" className="full-width bg-base-100 mt-72">
        <div className="px-8 py-8 bg-neutral rounded-box -mt-36 shadow-md">
                ...
                <div className="card bg-neutral shadow-xl h-full">
                  <div className="card-body items-center text-center">
                    ...
                    <div className="card-actions justify-end">
                      <a
                        href="#"
                        className="link-hover link-primary group/link"
                      >
                        Learn more{" "}
