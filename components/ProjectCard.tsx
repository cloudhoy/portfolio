...
const ProjectCard = ({
  ...
  return (
    <a href={href} target="_blank" className="group">
      <div className="flex flex-col rounded-box md:flex-row items-start gap-4 transition-all md:px-4 py-8 md:hover:!opacity-100 md:group-hover/list:opacity-50 md:hover:bg-base-100/50 md:hover:shadow-lg">
        <div className="md:w-1/4 shrink-0 grid">
          ...
          {status == "soon" && (
            <div className="z-10 col-start-1 row-start-1 badge badge-secondary float-end badge-sm">
              Coming soon
            </div>
          )}
          {status == "contributor" && (
