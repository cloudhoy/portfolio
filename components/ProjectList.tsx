    ...
    <ul className="group/list flex flex-col gap-4">
        ...
        <FadeInView>
          ...
          >
            ...
            <p className="mb-4 text-sm leading-loose">
              Roughly designed in Figma, developed with Next.js, hosted on AWS
              S3, and delivered via Cloudfront.
            </p>
        ...
        <FadeInView>
          ...
          >
            <p className="mb-4 text-sm leading-loose">
              ...
              curating accessible projects. Ideal for beginners making their
              first contribution, founders building teams, and maintainers
      ...
      <li>
        <FadeInView>
          ...
          >
            <p className="mb-4 text-sm leading-loose">
              Fully responsive e-commerce website, built with Next.js + Tailwind
              CSS.
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="badge badge-secondary badge-outline">React</span>
